...
| 2026-08-28 | PBP2a PepGLAD r19严格扩库完成包 | off-workstation content-addressed export；全量评分与冻结证据 | `/data0/ampgent-pepglad-huangyueshan/v1/artifacts/strict-library/364b56bf478897633bf890b97d827a364b53542f976214a3fa212ade2419c314/` | AMPgent；`.19 GPU7`已释放 | generation `fa67b3c...79d5`；12项评分后全局冻结 | 远端94 MiB | final CSV `364b56bf478897633bf890b97d827a364b53542f976214a3fa212ade2419c314`；score receipt `43e81a08...ace8`；strict subset `089209cd...e617`；freeze receipt `ab45afef...118c` | 88,789条严格候选、9,457家族；368条/368家族为本批新增；远端校验后删除本机精确中转 | succeeded_cas_frozen |
| 2026-08-28 | AceA r28与PBP2a r20并行PepGLAD短根 | remote generation execution copies；生成后评分再冻结 | AceA `/data0/ampgent-pepglad-huangyueshan/v1/results/acea-pepglad-novel-root-r28-short10-13-20260828T0215Z*`；PBP2a `/data0/ampgent-pepglad-huangyueshan/v1/results/pbp2a-pepglad-novel-root-r20-short10-13-20260828T0215Z-recovery-v1*` | AMPgent；`.19 GPU6`父PID2267181、`.19 GPU7`恢复父PID2268143 | seeds 2026082766/2026082767；各768 raw | 运行中 | AceA launch `4490f43d...e0433`；PBP2a首次失败 `437191d6...64e3`；独立恢复 launch `95d2369d...c520` | PBP2a首次失败尝试不可变；两条活动批次完成后全量12项评分、硬门与家族验收；不得重复提交 | generation_active_scoring_pending |
| 2026-08-28 | AceA PepGLAD r28严格扩库完成包 | off-workstation content-addressed export；全量评分与冻结证据 | `/data0/ampgent-pepglad-huangyueshan/v1/artifacts/strict-library/f7961993e1b7f6e401727780ec0c67f97c54418380f5cb87df7937e59b30899d/` | AMPgent；`.19 GPU6`已释放 | generation `b179c7db...1c24`；12项评分后全局冻结 | 远端94 MiB | final CSV `f7961993e1b7f6e401727780ec0c67f97c54418380f5cb87df7937e59b30899d`；score receipt `56834147...2b04`；strict subset `96ff3362...31e5`；freeze receipt `8e671ff4...5fa4` | 89,078条严格候选、9,746家族；289条/289家族为本批新增；远端校验后删除本机精确中转 | succeeded_cas_frozen |
| 2026-08-28 | PBP2a r20 LOG碰撞失败与r20-v2/r21并行恢复 | immutable failure evidence + remote generation execution copies | 失败根 `/data0/ampgent-pepglad-huangyueshan/v1/results/pbp2a-pepglad-novel-root-r20-short10-13-20260828T0215Z-recovery-v1/`；活动r20-v2与r21同级目录 | AMPgent；GPU7父PID2754483、GPU6父PID2812305 | r20 seed2026082767；r21 seed2026082768 | 两批运行中；失败v1有768个未晋级PDB | v1 failure `51daf4d9...bd79`；v2 launch `78ae1ae5...8f3d`；r21 request `5742360e...f682`/launch `ecc18564...573b` | v1失败输出不可变且不晋级；v2/r21完成后分别全量评分、硬门和家族验收；不得原地重试 | generation_active_scoring_pending |
