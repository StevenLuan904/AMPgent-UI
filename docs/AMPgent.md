...
- v5 reserve100：582个独立家族；差集75在synth GPU1/6 PID `2748958`，已完成33、待续42；根 `/sdd_data/pepagent/ampgent/structure/rosetta-poola-v5-reserve100-diff75-synth-gpu1-6-20260902-v1/`。
...
- gap-target v8：GyrA/FGF2/ANGPT1各第101–159名59个独立家族，远端87,729行三层身份扫描重叠0；`.19` GPU0/1 PID `3054748`、ingester `3054827`、12个CPU worker，Boltz 1/177、失败0；launch SHA `5d65682c63744a0430eeeb6011e135c64d98bc8223533035e6a4d7cfc1f7b3f5`；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-v8-gap-targets-extension177-host019-gpu0-1-20260902-v1/`。
- PostgreSQL 严格 Pool A（2026-09-02 22:50）：AceA50、GyrA34、PBP2a39、VEGFA50、FGF2 35、ANGPT1 42；其余 reserve 正在补齐 5-decoy Rosetta 与收据入库。
