...
- priority v2：293条；前五靶点各50、VEGFA 43。相对v1新增22、移除5、净增17家族；新增22在synth GPU5/7 PID `2335217`、8个CPU worker，根 `/sdd_data/pepagent/ampgent/structure/rosetta-poola-priority-v2-append22-synth-gpu5-7-20260902-v1/`；v1已完成/在途结果保留，最终Pool A成员以v2为准。
