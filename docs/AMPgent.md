...
- 严格 Pool A priority276：与旧900重叠0；AceA/GyrA/PBP2a/FGF2/ANGPT1各50、VEGFA 26，按 exact run+Candidate UUID、独立80/80家族绑定；`.19` GPU2-7 PID `1933418`，24个CPU Rosetta worker，已完成201/276；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-priority276-coarse5-host019-gpu2-7-20260902-v1/`。
...
- v5 reserve100：582个独立家族；差集75在synth GPU1/6 PID `2748958`，已完成29、待续46；根 `/sdd_data/pepagent/ampgent/structure/rosetta-poola-v5-reserve100-diff75-synth-gpu1-6-20260902-v1/`。
...
- PBP2a v7：第101–159名59个独立家族，经87,670条远端队列身份扫描重叠0；`.19` GPU0/1 PID `2426846`、ingester `2428077`、12个CPU worker；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-v7-pbp2a-extension59-host019-gpu0-1-20260902-v1/`；已生成52个复合物、完成12个完整5-decoy结果，失败0。
- PostgreSQL 严格 Pool A（2026-09-02 22:33）：AceA50、GyrA28、PBP2a31、VEGFA50、FGF2 34、ANGPT1 36；其余 reserve 正在补齐 5-decoy Rosetta 与收据入库。
