...
- `.19` GPU0–7运行首批475条；synth `.2` GPU1运行新增11条；两队列身份无交集，统一总数486。当前23条已启动、9条完成MD/界面/MM/GBSA并入PostgreSQL。两端均为单best-decoy、1 ns NPT+50 ns NVT、checkpoint续算；`.2` 紧凑证据转交`.19`，PDB/DCD/checkpoint只留远端。
