...
- 严格 Pool A priority276：与旧900重叠0；AceA/GyrA/PBP2a/FGF2/ANGPT1各50、VEGFA 26，按 exact run+Candidate UUID、独立80/80家族绑定；`.19` GPU2-7 PID `1933418`，24个CPU Rosetta worker，已完成170/276；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-priority276-coarse5-host019-gpu2-7-20260902-v1/`；旧结果和checkpoint不变。
...
- PBP2a v7：第101–159名59个独立家族，经87,670条远端队列身份扫描重叠0；`.19` GPU0/1 PID `2426846`、ingester `2428077`、12个CPU worker；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-v7-pbp2a-extension59-host019-gpu0-1-20260902-v1/`；已生成24个复合物并进入Rosetta精修，失败0。
- PostgreSQL 严格 Pool A（2026-09-02 21:51）：AceA50、GyrA21、PBP2a18、VEGFA50、FGF2 30、ANGPT1 31；其余 reserve 正在补齐 5-decoy Rosetta 与收据入库。
