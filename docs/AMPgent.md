...
- 严格 Pool A priority276：与旧900重叠0；AceA/GyrA/PBP2a/FGF2/ANGPT1各50、VEGFA 26，按 exact run+Candidate UUID、独立80/80家族绑定；`.19` GPU2-7 PID `1933418`，24个CPU Rosetta worker，已完成185/276；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-priority276-coarse5-host019-gpu2-7-20260902-v1/`；旧结果和checkpoint不变。
...
- v4 reserve100：515个独立家族；差集206在synth GPU2/3 PID `2537984`，已完成26、待续180；根 `/sdd_data/pepagent/ampgent/structure/rosetta-poola-v4-reserve100-diff206-synth-gpu2-3-20260902-v1/`。
- v5 reserve100：582个独立家族；差集75在synth GPU1/6 PID `2748958`，已完成25、待续50；根 `/sdd_data/pepagent/ampgent/structure/rosetta-poola-v5-reserve100-diff75-synth-gpu1-6-20260902-v1/`。
...
- PBP2a v7：第101–159名59个独立家族，经87,670条远端队列身份扫描重叠0；`.19` GPU0/1 PID `2426846`、ingester `2428077`、12个CPU worker；根 `/data1/huangyueshan/pepagent/data/run-cache/rosetta-poola-v7-pbp2a-extension59-host019-gpu0-1-20260902-v1/`；已生成38个复合物、完成10个完整5-decoy结果，失败0。
- PostgreSQL 严格 Pool A（2026-09-02 22:10）：AceA50、GyrA26、PBP2a29、VEGFA50、FGF2 31、ANGPT1 35；其余 reserve 正在补齐 5-decoy Rosetta 与收据入库。
