...
- PBP2a后备：现有reserve100已完成19、dG通过11；另备第101–159名59个独立家族，未提交，仅在现有队列不足50时启用。
- PostgreSQL 严格 Pool A（2026-09-02 21:00）：AceA38、GyrA13、PBP2a11、VEGFA50、FGF2 24、ANGPT1 21；其余 reserve 正在补齐 5-decoy Rosetta 与收据入库。
