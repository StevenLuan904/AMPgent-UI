...
- `.19` Pool A MD v1：475/475复合物已解析；GPU0–7 exact-once常驻调度，单候选单best-decoy、1 ns NPT+50 ns NVT、checkpoint续算；几何分析与MM/GBSA自动触发；仅同步紧凑JSON/CSV入库，PDB/DCD/checkpoint留远端；根`/data1/huangyueshan/pepagent/md/pool-a-full-md-v1/`。
