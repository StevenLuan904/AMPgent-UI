...
- `.19` Pool A MD v1：475/475复合物已解析；GPU0–7 exact-once常驻调度，单候选单best-decoy、1 ns NPT+50 ns NVT、checkpoint续算；PBC-corrected interface v2、MM/GBSA、PostgreSQL幂等入库与候选/分靶点汇总常驻自动触发；仅同步紧凑JSON/CSV，PDB/DCD/checkpoint留远端；根`/data1/huangyueshan/pepagent/md/pool-a-full-md-v1/`。
