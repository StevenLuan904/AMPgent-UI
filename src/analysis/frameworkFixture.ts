...
export const frameworkFixture: AnalysisDataset = {
  runLabel: 'AMP design · framework preview',
  generators: [
  ...
  sourcePatterns: [
    { label: 'AMP Designer only', count: 11 },
    { label: 'AMPGAN only', count: 7 },
    { label: 'HydrAMP only', count: 5 },
    { label: 'Designer + AMPGAN', count: 6 },
    { label: 'Designer + HydrAMP', count: 3 },
    { label: 'AMPGAN + HydrAMP', count: 2 },
    { label: 'All generators', count: 1 },
  ],
  distributions: [
